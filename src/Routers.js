...
export const Routers = () => {
  return (
    <div className=" ">
      ...
      <>
        <Routes className="h-full w-full">
          ...
          <Route
            path="/shopping/women/wears/dresses/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/women/wears/skirts/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/women/wears/coats/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/women/wears/tops/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/women/wears/jackets/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/women/wears/trousers/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/men/wears/trousers/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/men/wears/blousons/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/men/wears/jackets/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/women/bags/:WBagName/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/women/shoes/:WShoeName/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/men/shoes/:MShoeName/:ProductId"
            Component={ProductsUI}
          />
          <Route
            path="/shopping/men/bags/bagpacks/:MBagName/:ProductId"
            Component={ProductsUI}
          />
