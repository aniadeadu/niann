   ...
   const Images = (index) => {
      return (
         <img  
            ...
            style={{WebkitMaskImage: "linear-gradient(to right, rgba(0,0,0,.88), rgba(0,0,0,.9))"}}
         />
      )
   }
         ...
         <main className='relative w-full h-screen '>
            <>
               ...
               <div
                  onClick={() => back()}
               >
                  <img src={arrow_back} className='w-5 cursor-pointer absolute top-[50%] left-[8%]'/>
               </div>
               <div
                  onClick={() => forward()}
               >
                  <img src={arrow_forward} className='w-5 cursor-pointer absolute top-[50%] right-[8%]'/>
               </div>
            </>
            ...
            <section>
               ...
               <section>
                  <HeroUI setcurrentIndex={setcurrentIndex} currentIndex={currentIndex}/> 
               </section>
            </section>
         </main>  
      </div>
